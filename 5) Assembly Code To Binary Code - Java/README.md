...
## Source Code for project is in My other Repository : [AssemblyCodeToBinaryCode](https://github.com/SaiNikhileshReddy/AssemblyCodeToBinaryCode).
...
<img src = "CMD-Output.jpg" width = "1000">

#### Using direct usage of "java UserInterface" :
<img src = "UserInterface-Output.jpg" width = "1000">

### Verification using Emulator(Nand2Tetris-Tools)
<img src = "Emulator.jpg" width = "1000">
